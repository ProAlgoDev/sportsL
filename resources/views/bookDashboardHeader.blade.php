<div class="book_dashboard_header">
        ...
        <div class="book_header">
                <button ><img src='{{asset("images/avatar/$teamAvatar")}}' alt="" /></button>
        ...
        <div class="book_date_switch">
                <form action="{{route('validate_book_dashboard')}}" method="POST" id='dateForm'>
                        @csrf
                        <input type="radio" name='date_switch' id='all' value="all" {{
                                Request::is("book_dashboard/$teamId/all") ? 'checked' : '' }} />
                        <input type="radio" name='date_switch' id='year' value="year" {{
                                Request::is("book_dashboard/$teamId/year") ? 'checked' : '' }} />
                        <input type="radio" name='date_switch' id='month' value="month" {{
                                Request::is("book_dashboard/$teamId/month") ? 'checked' : '' }} />
